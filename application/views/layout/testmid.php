<div id='Books' class='homeCategory'>
  ...
  <div class='itemSection'>
    ...
    <card cardTitle='<?=$ksiazka->tytul_ksiazki?>' cardCover='<?=$ksiazka->okladka?>'  cardActionHref='/ksiazka/<?=$ksiazka->id_ksiazki?>' cardType='0'></card>
    <?php endforeach; ?>
  </div>
</div>
...
<div id='Film' class='homeCategory'>
  ...
  <div class='itemSection'>
    ...
    <card cardTitle='<?=$film->tytul_filmu?>' cardCover='<?=$film->okladka?>'  cardActionHref='/film/<?=$film->id_filmu?>' cardType='2'></card>
    <?php endforeach; ?>
  </div>
</div>
...
<div id='Music' class='homeCategory'>
  ...
  <div class='itemSection'>
    ...
    <card cardTitle='<?=$album->nazwa_albumu?>' cardCover='<?=$album->okladka?>'  cardActionHref='/album/<?=$album->id_albumu?>' cardType='2'></card>
    <?php endforeach; ?>
  </div>
</div>