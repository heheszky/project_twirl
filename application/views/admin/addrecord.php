...
<?= form_open_multipart("/admin/addrecord", 'class="addBookForm"') ?>
	...
	<select class="multiple" id="gatunek_ksiazka" multiple="multiple" name="gatunek_ksiazka[]" style='display:none;'>
...
<?= form_open_multipart("/admin/addrecord", 'class="addBookForm"') ?>
	...
	<select class="multiple" id="gatunek_album" multiple="multiple" name="gatunek_album[]"  style='display:none;'>
...
<?= form_open_multipart("/admin/addrecord", 'class="addBookForm"') ?>
	...
	<select class="multiple" id="gatunek_film" multiple="multiple" name="gatunek_film[]"  style='display:none;'>
